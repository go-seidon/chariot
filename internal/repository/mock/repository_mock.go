...
func (m *MockRepository) GetBarrel() repository.Barrel {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) GetBarrel() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBarrel", reflect.TypeOf((*MockRepository)(nil).GetBarrel))
}
