...
func (m *MockBarrel) SearchBarrel(ctx context.Context, p repository.SearchBarrelParam) (*repository.SearchBarrelResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchBarrel", ctx, p)
	ret0, _ := ret[0].(*repository.SearchBarrelResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
