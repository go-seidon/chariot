...
var _ Barrel = (*barrelService)(nil)
...
func (b *barrelService) CreateBarrel(ctx context.Context, p CreateBarrelParam) (*CreateBarrelResult, *system.Error) {
...
func (b *barrelService) FindBarrelById(ctx context.Context, p FindBarrelByIdParam) (*FindBarrelByIdResult, *system.Error) {
	err := b.validator.Validate(p)
	if err != nil {
		return nil, &system.Error{
			Code:    status.INVALID_PARAM,
...
func (b *barrelService) UpdateBarrelById(ctx context.Context, p UpdateBarrelByIdParam) (*UpdateBarrelByIdResult, *system.Error) {
	err := b.validator.Validate(p)
	if err != nil {
		return nil, &system.Error{
			Code:    status.INVALID_PARAM,
...
func (b *barrelService) SearchBarrel(ctx context.Context, p SearchBarrelParam) (*SearchBarrelResult, *system.Error) {
	err := b.validator.Validate(p)
	if err != nil {
		return nil, &system.Error{
			Code:    status.INVALID_PARAM,
...
func NewBarrel(p BarrelParam) *barrelService {
